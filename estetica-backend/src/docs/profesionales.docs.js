// ============================================================================
//  DOCUMENTACIÓN SWAGGER  ·  Profesionales y Agendas
// ============================================================================
...
/**
 * @swagger
 * /api/professionals/{id}/availability/archive-month:
 *   patch:
 *     summary: Archivar la disponibilidad de un mes completo
 *     tags:
 *       - Disponibilidad
 *     security:
 *       - bearerAuth: []
 ...
 *     responses:
 *       200:
 *         description: Agenda archivada (devuelve slots archivados y turnos a reprogramar)
 *       400:
 *         description: year y month son obligatorios
 *       403:
 *         description: Solo podés gestionar tu propia agenda
 *       401:
 *         description: Token inválido o ausente
 */
...
/**
 * @swagger
 * /api/professionals/{id}/availability/{availabilityId}/archive:
 *   patch:
 *     summary: Archivar un slot de disponibilidad puntual
 *     tags:
 *       - Disponibilidad
 *     security:
 *       - bearerAuth: []
 ...
 *     responses:
 *       200:
 *         description: Slot archivado (devuelve turnos a reprogramar)
 *       403:
 *         description: Solo podés gestionar tu propia agenda
 *       404:
 *         description: Slot no encontrado
 ...
 *         description: Slot no encontrado
 *       409:
 *         description: No se puede eliminar un slot con turnos asociados
 *       401:
 *         description: Token inválido o ausente
 */